...
function generatePassword() {
  var passwordLength = prompt("What length would you like your new password to be? (Please choose a value between 1 and 128)");
  ...
  if(passwordLength > 1 && passwordLength < 128){
    ...
    alert("The next few prompts will ask about the special characters you want to be present in your new passwords.");
    var useUpperCase = prompt("Would you like your new passsword to include \r\nCapitalized Letters? \r\nType 'yes' or 'no'");
    var useLowerCase = prompt("Would you like your new passsword to include \r\nLowercase Letters? \r\nType 'yes' or 'no'");
    var useNumericChars = prompt("Would you like your new passsword to include \r\nNumeric Characters? \r\nType 'yes' or 'no'");
    var useSpecialChars = prompt("Would you like your new passsword to include \r\nSpecial Character? \r\nType 'yes' or 'no'");

    // Checking to make sure at least one type of character has been selected
    if(useUpperCase != "" && useLowerCase != "" && useNumericChars != "" && useSpecialChars !=  ""){
...
// loop through as many times as the user wants their password length to be, and spit out a random character from a random category
  ...
  alert("Invalid Entry. Please select at least one character type. This program will now end. Please click the 'Generate Password' button to try again.");
}
  }
  else {
    alert("Invalid character entered. This program will now end. Please click the 'Generate Password' button to try again.");
  }
}
